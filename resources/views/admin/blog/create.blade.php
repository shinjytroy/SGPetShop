    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-primary">
          ...
          <form action="{{ Route('admin.blog.store') }}" method="post" class="card-body" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
              ...
              <input type="text" id="ssub_title" name="sub_title" class="form-control">
            </div>           
            <div class="form-group">
